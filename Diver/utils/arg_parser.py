...
class ArgParser(object):
    ...
    def parse_arguments(self,parser):
        ...
        parser.add_argument('-o',"--option",default = None, help = "Option for Testing SMT Solver, e.g., option1,option2,...")
        ...
        parser.add_argument('-m',"--mutants", default=1000, help = "Number of Mutants generated per seed (default = 1000)")
